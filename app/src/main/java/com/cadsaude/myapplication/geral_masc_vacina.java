...
public class geral_masc_vacina {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geral_masc_vacina);
        //adicionar toolbar
        ...
        //String videoPath2 = "android.resource://"+getPackageName()+"/"+R.raw.vacina_masc;
    ...
    public void openLibras() {
        if(IsOpen){
            ...
            mc.setVisibility(LinearLayout.GONE);
            mc2.setVisibility(LinearLayout.GONE);
            ...
            mc.setVisibility(LinearLayout.VISIBLE);
            mc2.setVisibility(LinearLayout.VISIBLE);
